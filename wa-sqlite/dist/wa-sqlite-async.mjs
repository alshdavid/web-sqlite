// @ts-expect-error
import _web_assembly_instantiate_ from './wa-sqlite-async.wasm'
...
var Module = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    function instantiateArrayBuffer(binaryFile, imports, receiver) {
      return _web_assembly_instantiate_(imports)
    ...
    function instantiateAsync(binary, binaryFile, imports, callback) {
      ...
      // ) {
      //   return _web_assembly_instantiate_(imports).then(callback)
